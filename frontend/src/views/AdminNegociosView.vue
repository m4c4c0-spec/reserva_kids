...
const accionando = ref(null) // id en proceso

const modalSuspender = ref(null) // negocio a suspender (confirmación)
...
function reemplazar(actualizado) {
  ...
  if (i !== -1) {
    // Si hay filtro de estado y el negocio ya no calza, quítalo de la lista.

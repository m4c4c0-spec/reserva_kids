  ...
  <section class="space-y-5">
    <div class="flex items-center justify-between gap-2">
      <div>
        ...
        <p class="font-medium text-on-surface-variant text-sm mt-0.5">
          Marca los días y horas en que puedes hacer fiestas. Tus clientes solo pueden reservar dentro de estos
          horarios.
        </p>
      </div>
      <input
    ...
    <ul v-else class="grid gap-3 sm:grid-cols-3">
      <li v-for="b in bloques" :key="b.id" class="card-festiva !rounded-2xl space-y-1.5">
        ...
        <p v-if="b.estado !== 'DISPONIBLE'" class="flex items-center gap-1 text-[11px] font-semibold text-green-800">
